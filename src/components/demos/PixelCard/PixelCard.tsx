...
// Cartão com chuva de pixels animada em canvas ao passar o mouse/focar.
...
export interface PixelCardProps {
  variant?: "default" | "accent" | "blue" | "yellow" | "pink";
  gap?: number;
  speed?: number;
  /** Lista de cores separadas por vírgula. */
  colors?: string;
  noFocus?: boolean;
  className?: string;
...
export default function PixelCard({
  ...
  // Checa preferência de movimento reduzido só no cliente.
    ...
    >
      ...
      {children ?? (
        <div className={styles.demoContent}>
          <h3 className={styles.demoTitle}>Pixels</h3>
          <p className={styles.demoText}>Passe o mouse aqui</p>
        </div>
      )}
    </div>
  );
