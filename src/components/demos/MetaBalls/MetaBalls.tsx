...
// Bolhas liquidas (metaballs) em shader WebGL via OGL. Uma bolha extra
// segue o cursor com suavizacao; os eventos de ponteiro ficam restritos
// ao container do componente.
...
// Hashes deterministicos para gerar orbitas variadas por bolha
...
const MetaBalls: React.FC<MetaBallsProps> = ({
  ...
  useEffect(() => {
    ...
    function update(t: number) {
      ...
      // Orbitas individuais de cada bolha
      for (let i = 0; i < effectiveBallCount; i++) {
      ...
      // Bolha do cursor: segue o ponteiro ou orbita o centro
