...
// Grainient, gradiente granulado com warp em shader WebGL2 (OGL).
// Componente TypeScript + CSS Module. Requer `ogl` (WebGL2).
...
// Mantém renderer/program vivos entre re-renders para atualizar uniforms
// sem reconstruir o contexto WebGL.
...
export default function Grainient({
  ...
  // Sincroniza props -> uniforms (sem custo de GPU, sem teardown).
  useEffect(() => {
    const container = containerRef.current;
    if (!container) return;
